...
const Index = () => {
 ...
 <div className="flex justify-center items-center h-full p-8 ">
  ...
  <form action="" style={formStyle} className="w-full max-w-lg bg-white shadow-md px-8 pt-6 pb-8 mb-4">
     ...
     <p style ={alertStyle} className="text-lg italic">Ya casi terminas!</p>
     </div>
     ...
     <input style={inputStyle} class="appearance-none block w-full bg-white text-gray-700 py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="tel"></input>
     </div>
 
     <div className="w-full md:w-1/2 mb-6 px-3">
     <label className="block uppercase tracking-wide text-gray-700 text-xs font-medium mb-1 ml-3" for="grid-last-name">
       Correo Electrónico Extra
     </label>
     <input style={inputStyle} class="appearance-none block w-full bg-white text-gray-700 py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="email"></input>
     </div>
